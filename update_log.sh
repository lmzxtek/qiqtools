...
echoT "--------------------------------"
echoR " >>> 2024-3-23   v0.5.1" " $VLATEST"
echoY "   1.添加腾讯、清华、中科院源更换。"
echoY "   2.添加Warp(@p3terx)、Warp-go。"
echoY "   3.查询系统信息时，重新调用信息获取函数。"
echoY "   4.系统设置中添加系统信息入口。"
echoY "   5.添加DeepLX接口服务(包括Docker部署)。"
echoY "   6.增加卸载nginx功能。"
echoY "   7.设置IPv6域名解析的时候先进行备份。"
echoT "--------------------------------"