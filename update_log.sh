...
echoT "   2.修改DD菜单实现方式。"
echoT "--------------------------------"
echoR " >>> 2024-3-19   v0.5.0" " $VLATEST"
echoY "   1.添加WatchTower容器部署，随时更新容器镜像。"
echoY "   2.添加WireGuard Panel容器部署。"
echoY "   3.添加XBorad部署。"
echoY "   4.添加LotusBoard部署。"
echoY "   5.添加AKJupyter-Lab部署。"
echoY "   6.添加Jupyter-Lab部署。"
echoT "--------------------------------"