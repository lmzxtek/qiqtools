...
echoT "--------------------------------"
echoR " >>> 2024-6-20   v0.5.7" " "
echoR "   1.增加谷歌浏览器Chrome的安装。"
echoR "   2.增加pip的安装。"
echoR "   3.修改Caddy搭建网站时本地IP的默认值。"
echoR "   4.增加pure-ftp的常用工具安装。"
echoR "   5.增加Jupyter-lab非Docker部署。"
echoR "   6.增加Conda-forge的安装。"
echoT "--------------------------------"
