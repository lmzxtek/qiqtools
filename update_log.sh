...
echoT "--------------------------------"
echoR " >>> 2025-01-01   v0.6.4" " $VLATEST"
echoY "   1.增加Sky-Box工具箱。"
echoY "   2.添加Docker-Wechat部署。"
echoY "   3.添加IPTV部署。"
echoY "   4.增加DD选项 WinServer2025, 并去除2012。"
echoY "   5.修改安装所有软件选项为常用的工具：btop,failban,supervisor..."
echoT "--------------------------------"