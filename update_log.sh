...
echoT "   4.增加IP管理工具的安装。"
echoT "--------------------------------"
echoR " >>> 2024-10-04   v0.6.3" " $VLATEST"
echoY "   1.增加Sublink订阅管理部署(bin+docker)。"
echoY "   2.增加Lucky转发的部署(bin(v2.11.2)+docker)。"
echoY "   3.增加Docker-win/Docker-mac部署。"
echoY "   4.增加DataEase命令部署。"
echoY "   5.系统设置增加SSH转发功能开启。"
echoY "   6.添加容器网络1panel-v4v6。"
echoY "   7.Set Aliyun(pip)。"
echoY "   8.恢复Kejilion脚本大陆安装链接。"
echoY "   9.增加JumpServer堡垒机命令部署。"
echoT "--------------------------------"