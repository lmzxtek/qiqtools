...
echoT "--------------------------------"
echoR " >>> 2024-3-26   v0.5.2" " $VLATEST"
echoY "   1.添加KASM平台的部署。"
echoY "   2.添加Neko平台的部署。"
echoY "   3.添加Neko-Rooms平台的部署。"
echoY "   4.添加Tor-Browser平台的部署。"
echoY "   5.添加Online Browser安装程序。"
echoY "   6.添加LinuxServer(firefox|Chromium)容器部署。"
echoT "--------------------------------"