...
echoT "--------------------------------"
echoR " >>> 2024-6-20   v0.5.7" " $VLATEST"
echoY "   1.增加谷歌浏览器Chrome的安装。"
echoY "   2.增加pip的安装。"
echoY "   3.修改Caddy搭建网站时本地IP的默认值。"
echoY "   4.增加pure-ftp的常用工具安装。"
echoY "   5.增加Jupyter-lab非Docker部署。"
echoY "   6.增加Conda-forge的安装。"
echoT "--------------------------------"