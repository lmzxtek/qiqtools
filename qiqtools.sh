...
main_menu() {
  ...
  WANIP_show
  txtn "====================================="
  txtn $(txty " 1." "系统信息" $(txtb "☄")) "       " $(txtn "11." "容器管理" $(txtb "❂"))
  txtn $(txty " 2." "系统更新" $(txtb "☣")) "       " $(txtn "12." "站点管理" $(txtb "❈"))
  txtn $(txty " 3." "系统清理" $(txtb "☢")) "       " $(txtn "13." "站点部署" $(txtb "ஐ"))
  txtn "-------------------------------------"
  txtn $(txtn "21." "常用工具" $(txtb "❃")) "       " $(txtn "31." "面板工具" $(txtb "◈"))
  txtn $(txtn "22." "系统工具" $(txtb "❁")) "       " $(txtn "32." "其他工具" $(txtb "☃"))
  txtn $(txtn "23." "节点工具" $(txtb "✈")) "       " $(txtn "" "" $(txtb ""))
  txtn "-------------------------------------"
  txtn $(txtn "99." "重启系统" $(txtb "❂")) "       " $(txtn "00." "脚本更新" $(txtb "♨"))
  txtn "====================================="
  txtn $(txtn " 0." "退出脚本" $(txtb "✖")) "       " $(txtn "♧♧ " "QiQTools " $(txtb "$script_version"))
